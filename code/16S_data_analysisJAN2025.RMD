...
ggsave("../results/Figures/Feb_AlphaDiversity.pdf", width=15, height=10)
```
...
```{r save-alpha-diversity-plot, eval=FALSE}
ggsave("../results/Figures/Feb_AlphaDiversity_no_Wolbachia.pdf", width=15, height=10)
```
